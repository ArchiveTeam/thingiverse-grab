...
More information about the archiving project can be found on the ArchiveTeam wiki: [Thingiverse](http://archiveteam.org/index.php?title=Thingiverse)
...
-------------------------
NOT AVAILABLE YET
Follow the [instructions on the ArchiveTeam wiki](http://archiveteam.org/index.php?title=Warrior) for installing the Warrior, and select the "Thingiverse" project in the Warrior interface.
...
### For Debian/Ubuntu:
    ...
    screen su -c "cd /home/archiveteam/thingiverse-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam
    [... ctrl+A D to detach ...]
...
**There is a known issue with some packaged versions of rsync. If you get errors during the upload stage, thingiverse will not work with your rsync version.**
...
6. `screen su -c "cd /home/archiveteam/thingiverse-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
